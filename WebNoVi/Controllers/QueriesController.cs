...
namespace WebNoVi.Controllers
{
    public class QueriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "QueryId,Date,Name,Email,Subject,Message")] Query query)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "QueryId,Date,Name,Email,Subject,Message")] Query query)
        {
            if (ModelState.IsValid)
            {
