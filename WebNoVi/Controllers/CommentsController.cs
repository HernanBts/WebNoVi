...
namespace WebNoVi.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            var comments = db.Comments.Include(c => c.Story);
        ...
        {
            ViewBag.StoryId = new SelectList(db.Stories, "StoryId", "Title");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "CommentId,UserName,Date,Body,Mail,StoryId")] Comment comment)
        {
            ...
            ViewBag.StoryId = new SelectList(db.Stories, "StoryId", "Title", comment.StoryId);
            return View(comment);
        }
